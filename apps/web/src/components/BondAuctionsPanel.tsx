...
export function BondAuctionsPanel() {
  const [snapshot, setSnapshot] = useState<TreasuryAuctionsSnapshot | "error" | null>(null);
  ...
  return (
    <div className="module-view">
      <div className="module-banner">
        <div>
          ...
          <div className="module-banner-sub">
            Upcoming US Treasury bill/note/bond auctions, live via TreasuryDirect.
          </div>
        </div>
      </div>
      ...
      <div className="note-banner">
        UK DMO gilt auctions: no scrapable free feed found for this environment — see the{" "}
        <a href="https://www.dmo.gov.uk/data/gilt-market/" target="_blank" rel="noreferrer">
